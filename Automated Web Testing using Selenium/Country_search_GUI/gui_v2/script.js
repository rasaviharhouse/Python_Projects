...
function showCountryDetails(country, details, img_url) {
    ...
    detailsContainer.innerHTML = ` <div class="row"><div class="col-sm"><h3>${country}</h3><p>${details}</p></div><div class="col-sm"> <img src=${img_url} style="width: 50%; height: 30vh;"></div></div>`;
